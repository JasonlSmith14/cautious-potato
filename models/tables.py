...
class ParsedStatement(SQLModel, table=True, extend_existing=True):
...
class Statement(SQLModel, table=True, extend_existing=True):
...
class Transaction(TransactionInformation, table=True, extend_existing=True):
...
class Category(CategoryInformation, table=True, extend_existing=True):
